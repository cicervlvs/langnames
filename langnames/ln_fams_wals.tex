...
\def\langnames@fams@wals@aaj{Austronesian}
...
\def\langnames@fams@wals@bos{nan}
...
\def\langnames@fams@wals@bvv{nan}
...
\def\langnames@fams@wals@den{nan}
...
\def\langnames@fams@wals@dgl{nan}
...
\def\langnames@fams@wals@din{nan}
...
\def\langnames@fams@wals@dmd{nan}
...
\def\langnames@fams@wals@dnj{nan}
...
\def\langnames@fams@wals@dwu{nan}
...
\def\langnames@fams@wals@gub{nan}
...
\def\langnames@fams@wals@hai{nan}
...
\def\langnames@fams@wals@hrc{nan}
...
\def\langnames@fams@wals@izz{nan}
...
\def\langnames@fams@wals@jya{nan}
...
\def\langnames@fams@wals@kex{nan}
...
\def\langnames@fams@wals@kzj{nan}
...
\def\langnames@fams@wals@luy{nan}
...
\def\langnames@fams@wals@nad{nan}
...
\def\langnames@fams@wals@ngo{nan}
...
\def\langnames@fams@wals@sqi{nan}
...
\def\langnames@fams@wals@tpq{nan}
...
\def\langnames@fams@wals@urf{nan}
...
\def\langnames@fams@wals@wnw{nan}
...
\def\langnames@fams@wals@wyu{nan}
...
\def\langnames@fams@wals@xnz{nan}
...
\def\langnames@fams@wals@xpq{nan}
...
\def\langnames@fams@wals@xra{nan}
...
\def\langnames@fams@wals@xyj{nan}
...
\def\langnames@fams@wals@yyr{nan}
